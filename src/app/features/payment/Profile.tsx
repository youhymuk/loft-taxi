        ...
        <section className={className}>
            ...
            <div className="profile-content-wrap">
                ...
                {!isCardDataUploaded || !cardNumber ? (
                    <>
                        <Formik
                            initialValues={{ cardName: '', cardNumber: cardNumber, expiryDate: '', cvc: '' }}
                            ...
                            {({ isSubmitting }) => (
                                <Form className="profile-form">
                                    ...
                                    <div className="profile-fields-wrap">
                                        <InputLabel className="profile-field-label">
                                            MM/YY
                                            <Field className="profile-field" type="number" name="expiryDate" />
                                        </InputLabel>
                                        <InputLabel className="profile-field-label">
                                            CVC
                                            <Field className="profile-field" type="number" name="cvc" />
                                        </InputLabel>
                                    </div>
